...
import com.bible.tools.extension.loge
import com.bible.tools.extension.logi
import com.bible.tools.utils.AbTestUtil
...
//        return AppUtils.getAppVersionCode().toLong() > version
    ...
    fun getFloatWindowTestGroupName(): String{
        ...
        return FireBaseConfigManager.getString("float_window_guide_page_test",AbTestUtil.FloatWindowOriginName)
    }
