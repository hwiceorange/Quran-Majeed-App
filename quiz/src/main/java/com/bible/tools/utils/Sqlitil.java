...
public class Sqlitil {
	static ThreadLocal<DateFormat> mediumDateFormat = new ThreadLocal<DateFormat>() {
		...
		protected DateFormat initialValue() {
			return android.text.format.DateFormat.getMediumDateFormat(BaseApp.Companion.getInstance());
		}
	};
	...
	static ThreadLocal<DateFormat> timeFormat = new ThreadLocal<DateFormat>() {
		@Override
		protected DateFormat initialValue() {
			return android.text.format.DateFormat.getTimeFormat(BaseApp.Companion.getInstance());
		}
	};
