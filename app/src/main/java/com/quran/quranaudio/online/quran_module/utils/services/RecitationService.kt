...
import com.quran.quranaudio.online.quran_module.utils.exceptions.NoInternetException
...
import com.quran.quranaudio.online.quran_module.utils.extensions.runOnInterval
...
import com.quran.quranaudio.online.quran_module.utils.reader.recitation.player.RecitationMediaItem
import com.quran.quranaudio.online.quran_module.utils.reader.recitation.player.RecitationPlayerParams
import com.quran.quranaudio.online.quran_module.utils.reader.recitation.player.RecitationPlayerVerseLoadCallback
import com.quran.quranaudio.online.quran_module.utils.reader.recitation.player.RecitationPlayerVerseLoader
import com.quran.quranaudio.online.quran_module.utils.receivers.NetworkStateReceiver
import com.quran.quranaudio.online.quran_module.utils.receivers.RecitationHeadsetReceiver
...
//            it.setUseStopAction(true)
    ...
    private fun loadVerse(
        ...
        if (!NetworkStateReceiver.isNetworkConnected(this)) {
            verseLoader.publishVerseLoadStatus(verseFile, verseTranslFile, callback, false,
               NoInternetException()
            )
            return
        }
