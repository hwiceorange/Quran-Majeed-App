...
import static com.quran.quranaudio.online.quran_module.utils.univ.RegexPattern.VERSE_RANGE_PATTERN;
...
import com.quran.quranaudio.online.quran_module.adapters.ADPQuickReference;
...
import com.quran.quranaudio.online.quran_module.components.quran.subcomponents.QuranTranslBookInfo;
import com.quran.quranaudio.online.quran_module.components.quran.subcomponents.Translation;
import com.quran.quranaudio.online.databinding.LytSheetVerseReferenceBinding;
import com.quran.quranaudio.online.databinding.LytSheetVerseReferenceHeaderBinding;
                        ...
                        if (actvt instanceof ActivityReader) {
                            msgView.setActionText(actvt.str(R.string.strTitleSettings), () -> {
                                ...
                                ((ActivityReader) actvt).mBinding.readerHeader.openReaderSetting(
                                    Activity_Quran_Settings.SETTINGS_TRANSLATION);
                            });
                        }
