package com.quran.quranaudio.online.quran_module.components.bookmark
...
class BookmarkModel(
    ...
    fun getFormattedDate(ctx: Context): String? {
        val oldFormatter = DateTimeFormatter.ofPattern(com.quran.quranaudio.online.quran_module.utils.univ.DateUtils.DATETIME_FORMAT_SYSTEM)
        try {
