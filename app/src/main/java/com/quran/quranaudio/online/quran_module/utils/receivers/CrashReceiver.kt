...
import com.quran.quranaudio.online.quran_module.utils.sharedPrefs.SPLog
    ...
    override fun onReceive(context: Context, intent: Intent?) {
        ...
        when (intent?.action) {
            ...
            CRASH_ACTION_CREATE_ISSUE -> {
                ...
                val browserIntent = Intent(Intent.ACTION_VIEW, Uri.parse(ApiConfig.WHATSAPP_REPORT_URL))
