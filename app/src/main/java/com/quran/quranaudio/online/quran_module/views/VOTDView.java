...
import com.quran.quranaudio.online.quran_module.components.quran.subcomponents.QuranTranslBookInfo;
import com.quran.quranaudio.online.quran_module.components.quran.subcomponents.Translation;
import com.quran.quranaudio.online.databinding.LytVotdBinding;
import com.quran.quranaudio.online.databinding.LytVotdContentBinding;
...
public class VOTDView extends FrameLayout implements Destroyable, BookmarkCallbacks {
    ...
    public VOTDView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mColorBookmarked = ContextCompat.getColor(context, R.color.white3);
    ...
    private void initActions(QuranMeta quranMeta) {
        mBinding.read.setVisibility(GONE);
        ...
        mContent.votdBookmark.setOnLongClickListener(v -> {
            v.getContext().startActivity(new Intent(v.getContext(), Activity_Quran_Bookmark.class));
            return true;
        });
