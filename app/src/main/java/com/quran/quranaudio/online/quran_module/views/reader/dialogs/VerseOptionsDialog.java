...
import com.quran.quranaudio.online.quran_module.components.quran.subcomponents.Translation;
import com.quran.quranaudio.online.quran_module.components.reader.ChapterVersePair;
import com.quran.quranaudio.online.databinding.LytReaderVodBinding;
import com.quran.quranaudio.online.databinding.LytReaderVodItemBinding;
...
public class VerseOptionsDialog extends PeaceBottomSheet implements View.OnClickListener, BookmarkCallbacks {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btnPlayControl) {
            ...
            AppBridge.newOpener(actvt).browseLink(ApiConfig.VERSE_REPORT_URL);
        }
    }
