package com.quran.quranaudio.online.quran_module.widgets.tablayout;
...
import com.quran.quranaudio.online.quran_module.utils.gesture.HoverPushEffect;
...
public class BottomTabView extends LinearLayout {
    ...
    private void initThisParams(BottomTab tab) {
        ...
        params = new LayoutParams(width, dimen);
    ...
    private void initIconView(BottomTab tab) {
        ...
        LayoutParams params = new LayoutParams(isKingTab ? WRAP_CONTENT : dimen, dimen);
        params.gravity = Gravity.CENTER;
