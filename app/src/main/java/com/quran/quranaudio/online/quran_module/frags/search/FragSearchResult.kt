package com.quran.quranaudio.online.quran_module.frags.search
...
import com.quran.quranaudio.online.databinding.FragSearchResultsBinding
import com.quran.quranaudio.online.quran_module.activities.ActivityQuran_Search
import com.quran.quranaudio.online.quran_module.adapters.search.ADPVerseResults
...
class FragSearchResult : BaseFragment(), Destroyable {
    ...
    private fun initTransls(actvt: ActivityQuran_Search) {
    ...
    private fun initRecyclerView(context: Context) {
        ...
        mBinding.let {
            ...
            it.results.addItemDecoration(
                GapedItemDecoration(
                    Dimen.dp2px(context, 5f)
                )
            )
        }
    }

    fun initSearch(activitySearch: ActivityQuran_Search) {
        initTransls(activitySearch)
        searchAsync(activitySearch)
    }

    private fun searchAsync(activitySearch: ActivityQuran_Search) {
    ...
    private fun searchAsyncAfterTranslReady(activity: ActivityQuran_Search, meta: QuranMeta) {
        mTaskRunner.cancel()
