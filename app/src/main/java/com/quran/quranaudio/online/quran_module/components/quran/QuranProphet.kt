...
import com.quran.quranaudio.online.quran_module.utils.quran.parser.QuranProphetParser
...
class QuranProphet(val prophets: List<Prophet>) {
    companion object {
        ...
        fun prepareInstance(context: Context, quranMeta: com.quran.quranaudio.online.quran_module.components.quran.QuranMeta, readyCallback: (QuranProphet) -> Unit) {
        ...
        private fun prepare(context: Context, quranMeta: com.quran.quranaudio.online.quran_module.components.quran.QuranMeta, readyCallback: (QuranProphet) -> Unit) {
