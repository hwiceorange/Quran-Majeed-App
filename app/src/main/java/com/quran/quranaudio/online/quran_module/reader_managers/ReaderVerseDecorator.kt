...
import com.quran.quranaudio.online.quran_module.utils.extensions.getDimension
...
class ReaderVerseDecorator(private val ctx: Context) {
    ...
    private val textColorAuthor by lazy { ctx.color(R.color.default_arc_solid_color) } //VOTD_Main
