package com.quran.quranaudio.online.Allah.names99.adapter;
...
public abstract class NamesAdapter extends RecyclerView.Adapter<NamesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        if (i == this.highlightPosition) {
            ...
            viewHolder.ayahRow.setBackgroundColor(Color.parseColor("#734E8545"));
            return;
        }
        viewHolder.ayahRow.setBackgroundColor(Color.parseColor("#FAFAFA"));
        viewHolder.tvMakkiMadni.setTextColor(Color.parseColor("#555555"));
        viewHolder.tvNameArabic.setTextColor(Color.parseColor("#4e8545"));
        viewHolder.tvNameEnglish.setTextColor(Color.parseColor("#4e8545"));
    }
