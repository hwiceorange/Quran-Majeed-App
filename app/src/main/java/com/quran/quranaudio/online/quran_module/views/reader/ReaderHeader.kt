...
import com.quran.quranaudio.online.databinding.LytReaderHeaderBinding
...
import com.quran.quranaudio.online.quran_module.utils.univ.Keys.READER_KEY_READ_TYPE
import com.quran.quranaudio.online.quran_module.utils.univ.Keys.READER_KEY_SAVE_TRANSL_CHANGES
import com.quran.quranaudio.online.quran_module.utils.univ.Keys.READER_KEY_SETTING_IS_FROM_READER
import com.quran.quranaudio.online.quran_module.utils.univ.Keys.READER_KEY_TRANSL_SLUGS
...
class ReaderHeader @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    fun openReaderSetting(destination: Int) {
        ...
        activity?.startActivity4Result(
            Intent(activity, Activity_Quran_Settings::class.java).apply {
                putExtra(Activity_Quran_Settings.KEY_SETTINGS_DESTINATION, destination)
