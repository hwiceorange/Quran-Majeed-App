package com.quran.quranaudio.online.hadith.search;
...
import com.quran.quranaudio.online.hadith.adapter.HadithAdapter;
...
public class Hadith_SearchActivity extends AppCompatActivity implements HadithInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CardView filterCardView = this.findViewById(R.id.filterCardView);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                Runnable runnable = () -> {
                    ...
                    setupHadithModels();
                    HadithAdapter adapter = new HadithAdapter(Hadith_SearchActivity.this, hadithModels, Hadith_SearchActivity.this);
                handler.post(() -> {
                    recyclerView.setAdapter(adapter);
                    recyclerView.setLayoutManager(new LinearLayoutManager(Hadith_SearchActivity.this));
