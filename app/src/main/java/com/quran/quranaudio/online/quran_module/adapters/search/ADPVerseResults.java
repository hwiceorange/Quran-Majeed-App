...
import com.quran.quranaudio.online.quran_module.adapters.extended.PeaceBottomSheetMenuAdapter;
...
import com.quran.quranaudio.online.quran_module.components.search.VerseResultCountModel;
import com.quran.quranaudio.online.quran_module.components.search.VerseResultModel;
...
import com.quran.quranaudio.online.databinding.LytSearchResultItemBinding;
...
import com.quran.quranaudio.online.quran_module.frags.search.FragSearchResult;
...
import com.quran.quranaudio.online.quran_module.widgets.bottomSheet.PeaceBottomSheetMenu;
...
public class ADPVerseResults extends RecyclerView.Adapter<VHSearchResultBase> implements Destroyable {
    ...
    private ActivityQuran_Search mActivity;
    ...
    public int getItemViewType(int position) {
        ...
        if (modelBase instanceof VerseJumpModel) {
            return ActivityQuran_Search.SearchResultViewType.VERSE_JUMPER;
        } else if (modelBase instanceof ChapterJumpModel) {
            return ActivityQuran_Search.SearchResultViewType.CHAPTER_JUMPER;
        } else if (modelBase instanceof JuzJumpModel) {
            return ActivityQuran_Search.SearchResultViewType.JUZ_JUMPER;
        } else if (modelBase instanceof TafsirJumpModel) {
            return ActivityQuran_Search.SearchResultViewType.TAFSIR_JUMPER;
        } else if (modelBase instanceof VerseResultCountModel) {
            return ActivityQuran_Search.SearchResultViewType.RESULT_COUNT;
        } else if (modelBase instanceof VerseResultModel) {
            return ActivityQuran_Search.SearchResultViewType.RESULT;
        }
        return -1;
    }
    ...
    public VHSearchResultBase onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case ActivityQuran_Search.SearchResultViewType.VERSE_JUMPER:
                vh = new VHVerseJump(new AppCompatTextView(parent.getContext()), false);
                break;
            case ActivityQuran_Search.SearchResultViewType.CHAPTER_JUMPER:
                vh = new VHChapterJump(new ChapterCard(parent.getContext()), false);
                break;
            case ActivityQuran_Search.SearchResultViewType.JUZ_JUMPER:
                vh = new VHJuzJump(LytReaderJuzSpinnerItemBinding.inflate(mInflater, parent, false), false);
                break;
            case ActivityQuran_Search.SearchResultViewType.TAFSIR_JUMPER:
                vh = new VHTafsirJump(new IconedTextView(parent.getContext()), false);
                break;
            case ActivityQuran_Search.SearchResultViewType.RESULT_COUNT:
                vh = new VHVerseResultCount(makeResultCountView(parent.getContext()));
                break;
            case ActivityQuran_Search.SearchResultViewType.RESULT:
    ...
    public void setActivitySearch(ActivityQuran_Search activitySearch) {
