...
import com.quran.quranaudio.online.quran_module.adapters.search.ADPSearchSugg;
...
import com.quran.quranaudio.online.databinding.FragSearchSuggestionsBinding;
...
public class FragSearchSuggestions extends BaseFragment implements Destroyable {
    ...
    public void initSuggestion(ActivityQuran_Search activitySearch, String query) throws NumberFormatException {
        boolean isEmpty = TextUtils.isEmpty(query);
        prepareNShowSugg(activitySearch, query, isEmpty);
    }

    private void prepareNShowSugg(ActivityQuran_Search activitySearch, String query, boolean isEmpty) {
    ...
    private ArrayList<SearchResultModelBase> prepareHistories(ActivityQuran_Search activitySearch, String query) {
