...
import com.quran.quranaudio.online.databinding.LytScriptDownloadProgressBinding
import com.quran.quranaudio.online.databinding.LytSettingsScriptItemBinding
...
import com.quran.quranaudio.online.quran_module.utils.extensions.getDimenPx
import com.quran.quranaudio.online.quran_module.utils.extensions.getFont
import com.quran.quranaudio.online.quran_module.utils.extensions.visible
import com.quran.quranaudio.online.quran_module.utils.reader.*
import com.quran.quranaudio.online.quran_module.utils.receivers.KFQPCScriptFontsDownloadReceiver
import com.quran.quranaudio.online.quran_module.utils.services.KFQPCScriptFontsDownloadService
import com.quran.quranaudio.online.quran_module.utils.services.KFQPCScriptFontsDownloadService.Companion.ALL_PART_DOWNLOADS_FINISHED
...
class FragSettingsScripts : FragSettingsBase(), ServiceConnection {
    ...
    private fun onItemClick(list: LinearLayout, binding: LytSettingsScriptItemBinding, slug: String) {
        ...
        if (binding.radio.isChecked) { SPReader.setSavedScript(ctx, slug)
        }
    }
