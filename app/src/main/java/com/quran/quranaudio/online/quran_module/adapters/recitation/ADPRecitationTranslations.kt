 ...
 */
package com.quran.quranaudio.online.quran_module.adapters.recitation
...
import com.quran.quranaudio.online.quran_module.adapters.recitation.ADPRecitationTranslations.VHRecitationTranslation
...
import com.quran.quranaudio.online.quran_module.utils.extensions.updatePaddingHorizontal
        ...
        fun bind(model: RecitationTranslationInfoModel) {
            ...
            radio.setOnClickListener { v ->
                if (isManageAudio) {
                    ...
                    com.quran.quranaudio.online.quran_module.utils.sharedPrefs.SPReader.setSavedRecitationTranslationSlug(v.context, model.slug)
                }
            }
        }
