...
import com.quran.quranaudio.online.databinding.LytReaderFooterBinding;
...
public class ReaderFooter extends FrameLayout {
    ...
    public void setupBottomNavigator() {
        ...
        switch (mReaderParams.readType) {
            case ReaderParams.READER_READ_TYPE_CHAPTER: setupFooterForChapter();
                break;
            case ReaderParams.READER_READ_TYPE_VERSES:
                ...
                break;
            case ReaderParams.READER_READ_TYPE_JUZ: setupFooterForJuz();
                break;
