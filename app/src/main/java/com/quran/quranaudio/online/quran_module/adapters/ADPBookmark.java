...
import com.quran.quranaudio.online.quran_module.adapters.extended.PeaceBottomSheetMenuAdapter;
import com.quran.quranaudio.online.quran_module.components.bookmark.BookmarkModel;
import com.quran.quranaudio.online.databinding.LytBookmarkItemBinding;
...
public class ADPBookmark extends RecyclerView.Adapter<ADPBookmark.VHBookmark> {
    ...
    private final Activity_Quran_Bookmark mActivity;
    ...
    public ADPBookmark(Activity_Quran_Bookmark activity, ArrayList<BookmarkModel> bookmarkModels) {
        mActivity = activity;
