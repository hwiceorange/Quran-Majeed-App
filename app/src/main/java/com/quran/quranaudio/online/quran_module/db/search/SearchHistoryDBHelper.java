package com.quran.quranaudio.online.quran_module.db.search;
...
import static com.quran.quranaudio.online.quran_module.db.search.SearchHistoryContract.SearchEntry.COL_TEXT;
import static com.quran.quranaudio.online.quran_module.db.search.SearchHistoryContract.SearchEntry.TABLE_NAME;
import static com.quran.quranaudio.online.quran_module.db.search.SearchHistoryContract.SearchEntry._ID;
...
import com.quran.quranaudio.online.quran_module.db.bookmark.BookmarkContract;
...
public class SearchHistoryDBHelper extends SQLiteOpenHelper {
    ...
    public void addToHistory(String text, Runnable runOnSucceed) {
        ...
        values.put(BookmarkContract.BookmarkEntry.COL_DATETIME, DateUtils.getDateTimeNow());
    ...
    public ArrayList<SearchResultModelBase> getHistories(String query) {
        ...
        String sortOrder = BookmarkContract.BookmarkEntry.COL_DATETIME + " DESC";
