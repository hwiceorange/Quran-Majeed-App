...
import com.quran.quranaudio.online.quran_module.utils.app.AppActions
import com.quran.quranaudio.online.quran_module.utils.app.NotificationUtils
import com.quran.quranaudio.online.quran_module.utils.extensions.getContentLengthAndStream
...
import com.quran.quranaudio.online.quran_module.utils.sharedPrefs.SPAppActions.removeFromPendingAction
...
class TranslationDownloadService : Service() {
    ...
    private fun prepareNotification(bookInfo: QuranTranslBookInfo): NotificationCompat.Builder {
        ...
        val activityIntent = Intent(this, Activity_Quran_Settings::class.java).apply {
            putExtra(
               Activity_Quran_Settings.KEY_SETTINGS_DESTINATION,
               Activity_Quran_Settings.SETTINGS_TRANSLATION_DOWNLOAD
            )
        }
