package com.quran.quranaudio.online.quran_module.utils.services
...
import com.quran.quranaudio.online.quran_module.components.recitation.ManageAudioChapterModel
...
import com.quran.quranaudio.online.quran_module.utils.extensions.serializableExtra
import com.quran.quranaudio.online.quran_module.utils.reader.recitation.RecitationUtils
import com.quran.quranaudio.online.quran_module.utils.receivers.RecitationChapterDownloadReceiver.Companion.ACTION_RECITATION_DOWNLOAD_STATUS
import com.quran.quranaudio.online.quran_module.utils.receivers.RecitationChapterDownloadReceiver.Companion.KEY_RECITATION_CHAPTER_MODEL
import com.quran.quranaudio.online.quran_module.utils.receivers.RecitationChapterDownloadReceiver.Companion.KEY_RECITATION_DOWNLOAD_PROGRESS
import com.quran.quranaudio.online.quran_module.utils.receivers.RecitationChapterDownloadReceiver.Companion.KEY_RECITATION_DOWNLOAD_STATUS
import com.quran.quranaudio.online.quran_module.utils.receivers.RecitationChapterDownloadReceiver.Companion.RECITATION_DOWNLOAD_STATUS_CANCELED
import com.quran.quranaudio.online.quran_module.utils.receivers.RecitationChapterDownloadReceiver.Companion.RECITATION_DOWNLOAD_STATUS_FAILED
...
class RecitationChapterDownloadService : Service() {
    ...
    private fun prepareNotification(
        ...
        val activityIntent = Intent(this, Activity_Quran_Settings::class.java).apply {
            putExtra(Activity_Quran_Settings.KEY_SETTINGS_DESTINATION, Activity_Quran_Settings.SETTINGS_MANAGE_AUDIO_RECITER)
