...
import com.quran.quranaudio.online.quran_module.utils.reader.toKFQPCFontFilename
...
class KFQPCScriptFontsDownloadService : LifecycleService() {
    ...
    private val notifActivityIntent by lazy {
        PendingIntent.getActivity(
            this,
            0,
            Intent(this, Activity_Quran_Settings::class.java).putExtra(
               Activity_Quran_Settings.KEY_SETTINGS_DESTINATION,
                Activity_Quran_Settings.SETTINGS_SCRIPT
            ),
            notifFlag
        )
    }
