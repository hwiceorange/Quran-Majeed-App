...
import com.quran.quranaudio.online.quran_module.adapters.recitation.ADPRecitations.VHRecitation
import com.quran.quranaudio.online.quran_module.api.models.recitation.RecitationInfoModel
import com.quran.quranaudio.online.databinding.LytSettingsRecitationItemBinding
        ...
        fun bind(model: RecitationInfoModel) {
            ...
            binding.root.setOnClickListener { v: View ->
                if (isManageAudio) {
                    ...
                    com.quran.quranaudio.online.quran_module.utils.sharedPrefs.SPReader.setSavedRecitationSlug(v.context, model.slug)
                }
            }
        }
