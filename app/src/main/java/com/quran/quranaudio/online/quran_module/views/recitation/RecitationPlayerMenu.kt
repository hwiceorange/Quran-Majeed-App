package com.quran.quranaudio.online.quran_module.views.recitation
...
import com.quran.quranaudio.online.databinding.LytAudioOptionExplorerBinding
import com.quran.quranaudio.online.databinding.LytPlaybackSpeedExplorerBinding
import com.quran.quranaudio.online.databinding.LytRecitationMenuBinding
...
import com.quran.quranaudio.online.quran_module.utils.univ.PopupWindow2
import com.quran.quranaudio.online.quran_module.utils.univ.RelativePopupWindow.HorizontalPosition
import com.quran.quranaudio.online.quran_module.utils.univ.RelativePopupWindow.VerticalPosition
...
class RecitationPlayerMenu(private val player: RecitationPlayer) {
    ...
    private fun setupView(binding: LytRecitationMenuBinding) {
        ...
        binding.selectReciter.setOnClickListener {
            close()
            player.activity.mBinding.readerHeader.openReaderSetting(Activity_Quran_Settings.SETTINGS_RECITER)
        }
        ...
        binding.manageAudio.setOnClickListener {
            close()
            player.activity.mBinding.readerHeader.openReaderSetting(Activity_Quran_Settings.SETTINGS_MANAGE_AUDIO)
        }
