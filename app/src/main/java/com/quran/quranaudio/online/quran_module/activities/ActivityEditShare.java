...
import com.quran.quranaudio.online.quran_module.interfaceUtils.editor.OnEditorChangeListener;
...
import com.quran.quranaudio.online.quran_module.components.quran.subcomponents.Translation;
import com.quran.quranaudio.online.databinding.ActivityEditShareBinding;
import com.quran.quranaudio.online.databinding.LytEditShareHeaderBinding;
import com.quran.quranaudio.online.databinding.LytEditorFinishBinding;
import com.quran.quranaudio.online.databinding.LytEditorTemplateScreenBinding;
...
import com.quran.quranaudio.online.quran_module.utils.editor.EditorUtils;
...
public class ActivityEditShare extends BaseActivity implements OnEditorChangeListener {
    ...
    private void onBGChangeFinal(EditorBG nBg) {
        if (nBg.getBgType() == VerseEditor.BG_TYPE_IMAGE) {
            mScreenMainBinding.bgImage.setImageDrawable(nBg.getBgImage());
            if (mVerseEditor.getLastBG() == null || (mVerseEditor.getLastBG().getBgType() != VerseEditor.BG_TYPE_IMAGE)) {
                mVerseEditor.setBGAlpha(VerseEditor.BG_ALPHA_DEFAULT);
        ...
        } else if (nBg.getBgType() == VerseEditor.BG_TYPE_COLORS) {
