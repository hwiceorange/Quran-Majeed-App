package com.quran.quranaudio.online.quran_module.views.reader.verseSpinner;
...
import com.quran.quranaudio.online.quran_module.views.reader.spinner.ReaderSpinner;
...
public class VerseSpinner extends ReaderSpinner {
    ...
    private void navigate(CharSequence searchQuery) throws NumberFormatException {
        if (mActivity.mReaderParams.readType == ReaderParams.READER_READ_TYPE_JUZ) {
    ...
    public void setAdapter(ReaderSpinnerAdapter<?> adapter) {
        ...
        int inputType = mActivity.mReaderParams.readType == ReaderParams.READER_READ_TYPE_JUZ ? InputType.TYPE_CLASS_TEXT : InputType.TYPE_CLASS_NUMBER;
