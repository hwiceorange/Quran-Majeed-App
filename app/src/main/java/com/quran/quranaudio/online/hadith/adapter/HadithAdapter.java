...
import com.quran.quranaudio.online.hadith.helper.MyDatabaseHelper;
...
public class HadithAdapter extends RecyclerView.Adapter<HadithAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyViewHolder(view, hadithInterface);
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (!model.getMarkedWord().isEmpty()) {
            ...
            if(Hadith_SearchActivity.isSearchTranslatedText && holder.hadithEnglishName.getText().toString().contains(model.getMarkedWord())) {
            ...
            if(Hadith_SearchActivity.isSearchNumber && holder.referenceText.getText().toString().contains(model.getMarkedWord())) {
            ...
            if(Hadith_SearchActivity.isSearchArabicText && holder.hadithArabicName.getText().toString().contains(model.getMarkedWord())) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private final CardView copyCardView;
        private final CardView bookmarkCardView;
    ...
    private void showDialogCopy(MyViewHolder holder, View mView) {
