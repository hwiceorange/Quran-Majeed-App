package com.quran.quranaudio.online.ads.adapter;
...
import com.quran.quranaudio.online.ads.model.Post;
        ...
        if (viewType == VIEW_ITEM) {
            ...
            switch (Constant.NATIVE_STYLE) {
                case "news":
                    ...
                    break;
                case "radio":
                    v = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_native_ad_radio, parent, false);
                    break;
                case "video_small":
                    v = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_native_ad_video_small, parent, false);
                    break;
                case "video_large":
                    v = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_native_ad_video_large, parent, false);
                    break;
                default:
