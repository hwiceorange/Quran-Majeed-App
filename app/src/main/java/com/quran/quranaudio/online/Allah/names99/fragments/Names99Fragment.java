...
public class Names99Fragment extends BaseFragment {
    ...
    public Runnable runnableTimeUpdate = new Runnable() {
        public void run() {
            if (Names99Fragment.this.mp != null) {
                Names99Fragment.this.handler.removeCallbacks(this);
                int currentPosition = Names99Fragment.this.mp.getCurrentPosition();
                Names99Fragment name99Fragment = Names99Fragment.this;
                String unused = name99Fragment.audioTotalTime = "" + Utils.milliSecondsToTimer((long) (Names99Fragment.this.totalDuration - currentPosition));
                Names99Fragment.this.tvTotalTime.setText(Names99Fragment.this.audioTotalTime);
                Names99Fragment.this.handler.postDelayed(this, 1000);
            }
        }
    };
    ...
    public Runnable sendUpdatesToUI = new Runnable() {
        public void run() {
            Names99Fragment.this.focusOnView();
            Names99Fragment.this.handler.postDelayed(this, 0);
        }
    };
    ...
    public int getLayoutId() {
        return R.layout.fragment_99names;
    }

    static  int access$908(Names99Fragment name99Fragment) {
        int i = name99Fragment.delayIndex;
        name99Fragment.delayIndex = i + 1;
        return i;
    }

    public static Names99Fragment newInstance() {
        Bundle bundle = new Bundle();
        Names99Fragment name99Fragment = new Names99Fragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle bundle) {
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                Names99Fragment.lambda$onViewCreated$1(Names99Fragment.this);
            }
        }, 400);
    }

    public static void lambda$onViewCreated$1(Names99Fragment name99Fragment) {
    ...
    private void initPlay() {
        this.btnAudio.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                Names99Fragment.lambda$initPlay$2(Names99Fragment.this, view);
            }
        });
    }

    public static  void lambda$initPlay$2(Names99Fragment name99Fragment, View view) {
    ...
    private void initAudio() {
        ...
        this.mp.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            public final void onPrepared(MediaPlayer mediaPlayer) {
                Names99Fragment.lambda$initAudio$3(Names99Fragment.this, mediaPlayer);
            }
        });
        this.mp.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            public final void onCompletion(MediaPlayer mediaPlayer) {
                Names99Fragment.this.reset();
            }
        });
    }

    public static /* synthetic */ void lambda$initAudio$3(Names99Fragment name99Fragment, MediaPlayer mediaPlayer) {
    ...
    private void initList() {
        ...
        this.namesAdapter = new NamesAdapter(this.activity, this.namesData) {
            public void OnItemClick(final int i) {
                if (Names99Fragment.this.play == 1) {
                    int unused = Names99Fragment.this.currentPosition = i;
                    Names99Fragment.this.handler.removeCallbacks(Names99Fragment.this.sendUpdatesToUI);
                    Names99Fragment.this.handler.post(Names99Fragment.this.sendUpdatesToUI);
                    Names99Fragment.this.handler.removeCallbacks(Names99Fragment.this.sendUpdatesToUI);
                    Names99Fragment.this.mp.pause();
                    Names99Fragment name99Fragment = Names99Fragment.this;
                    int unused2 = name99Fragment.delayIndex = name99Fragment.currentPosition;
                    Names99Fragment.this.namesAdapter.movePosition(Names99Fragment.this.currentPosition);
                    Names99Fragment.this.layoutManager.scrollToPosition(Names99Fragment.this.currentPosition);
                    Names99Fragment.access$908(Names99Fragment.this);
                    Names99Fragment.this.mp.seekTo(Names99Fragment.this.nameTiming[Names99Fragment.this.currentPosition]);
                    Names99Fragment.this.mp.start();
                    Names99Fragment.this.seekBarNames.setEnabled(true);
                    Names99Fragment.this.seekBarNames.setProgress(Names99Fragment.this.currentPosition);
                    Names99Fragment.this.handler.removeCallbacks(Names99Fragment.this.runnableTimeUpdate);
                    Names99Fragment.this.handler.post(Names99Fragment.this.runnableTimeUpdate);
                    Names99Fragment.this.handler.removeCallbacks(Names99Fragment.this.sendUpdatesToUI);
                    Names99Fragment.this.handler.postDelayed(Names99Fragment.this.sendUpdatesToUI, 0);
                    return;
                }
    ...
    private void initSb() {
        ...
        this.seekBarNames.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                if (Names99Fragment.this.play == 1 && z) {
                    int unused = Names99Fragment.this.currentPosition = i;
                    Names99Fragment.this.handler.removeCallbacks(Names99Fragment.this.sendUpdatesToUI);
                    Names99Fragment.this.handler.post(Names99Fragment.this.sendUpdatesToUI);
                    Names99Fragment.this.handler.removeCallbacks(Names99Fragment.this.runnableTimeUpdate);
