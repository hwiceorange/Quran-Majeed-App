package com.quran.quranaudio.online.quran_module.utils.sharedPrefs;

import android.content.Context;
import android.content.SharedPreferences;

import static com.quran.quranaudio.online.quran_module.utils.reader.ReaderTextSizeUtils.KEY_TEXT_SIZE_MULT_ARABIC;
import static com.quran.quranaudio.online.quran_module.utils.reader.ReaderTextSizeUtils.KEY_TEXT_SIZE_MULT_TAFSIR;
import static com.quran.quranaudio.online.quran_module.utils.reader.ReaderTextSizeUtils.KEY_TEXT_SIZE_MULT_TRANSL;
import static com.quran.quranaudio.online.quran_module.utils.reader.ReaderTextSizeUtils.TEXT_SIZE_MULT_AR_DEFAULT;
import static com.quran.quranaudio.online.quran_module.utils.reader.ReaderTextSizeUtils.TEXT_SIZE_MULT_TAFSIR_DEFAULT;
import static com.quran.quranaudio.online.quran_module.utils.reader.ReaderTextSizeUtils.TEXT_SIZE_MULT_TRANSL_DEFAULT;
import static com.quran.quranaudio.online.quran_module.utils.reader.TranslUtils.KEY_TRANSLATIONS;
...
public abstract class SPReader {
    ...
    public static float getRecitationSpeed(Context context) {
        ...
        return sp.getFloat(RecitationUtils.KEY_RECITATION_SPEED, RecitationUtils.RECITATION_DEFAULT_SPEED);
    }
    ...
    public static boolean getRecitationRepeatVerse(Context context) {
        ...
        return sp.getBoolean(RecitationUtils.KEY_RECITATION_REPEAT, RecitationUtils.RECITATION_DEFAULT_REPEAT);
    }
    ...
    public static boolean getRecitationScrollSync(Context context) {
        ...
        return sp.getBoolean(RecitationUtils.KEY_RECITATION_VERSE_SYNC, RecitationUtils.RECITATION_DEFAULT_VERSE_SYNC);
    }
    ...
    public static int getRecitationAudioOption(Context context) {
        ...
        return sp.getInt(RecitationUtils.KEY_RECITATION_AUDIO_OPTION, RecitationUtils.AUDIO_OPTION_DEFAULT);
    }
