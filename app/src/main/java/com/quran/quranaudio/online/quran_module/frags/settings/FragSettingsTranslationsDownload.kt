...
import com.quran.quranaudio.online.quran_module.components.transls.TranslationGroupModel
...
import com.quran.quranaudio.online.quran_module.interfaceUtils.TranslDownloadExplorerImpl
...
import com.quran.quranaudio.online.quran_module.utils.receivers.TranslDownloadReceiver
import com.quran.quranaudio.online.quran_module.utils.receivers.TranslDownloadReceiver.TranslDownloadStateListener
import com.quran.quranaudio.online.quran_module.utils.services.TranslationDownloadService
import com.quran.quranaudio.online.quran_module.utils.services.TranslationDownloadService.LocalBinder
...
class FragSettingsTranslationsDownload :
    ...
    private fun showLoader() {
        ...
        if (activity is Activity_Quran_Settings) {
            val header = (activity as Activity_Quran_Settings?)!!.header
            header.setShowRightIcon(false)
        }
    }
    ...
    private fun showAlert(titleRes: Int, msgRes: Int, btnRes: Int, action: Runnable) {
        ...
        pageAlert!!.let {
            ...
            (activity as? Activity_Quran_Settings)?.header?.apply {
                setShowRightIcon(true)
            }
        }
    }
