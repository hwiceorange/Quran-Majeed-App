package com.quran.quranaudio.online.quran_module.suppliments;
...
import com.quran.quranaudio.online.quran_module.activities.ActivityAbout;
import com.quran.quranaudio.online.quran_module.activities.Activity_Quran_Bookmark;
...
import com.quran.quranaudio.online.databinding.LytIndexMenuBinding;
import com.quran.quranaudio.online.databinding.LytIndexMenuItemBinding;
import com.quran.quranaudio.online.quran_module.utils.app.InfoUtils;
...
public class IndexMenu implements View.OnClickListener, Destroyable {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.indexMenuItemBookmark) {
            mActivity.launchActivity(Activity_Quran_Bookmark.class);
        } else if (id == R.id.indexMenuItemSettings) {
            mActivity.launchActivity(Activity_Quran_Settings.class);
