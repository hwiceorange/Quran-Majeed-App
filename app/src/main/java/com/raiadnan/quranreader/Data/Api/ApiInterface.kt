package com.raiadnan.quranreader.Data.Model.Api

import android.provider.DocumentsContract
import com.raiadnan.quranreader.Data.Model.Pojo.*
...
interface ApiInterface {
    ...
    fun getFrenchSurah(@Path("surahNumber") numSurah:Int):Call<DocumentsContract.Root>
